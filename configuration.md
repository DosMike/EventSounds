...
**DeathCause:** The entity or damage-type responsible for this players death.
In order to specify a mob type go to [the wiki](https://minecraft.gamepedia.com/Mob), 
pick a mob and use the Entity ID prefixed by minecraft and a colon (Like `minecraft:pig` for pigs)
for a damage-type go [here](https://minecraft.gamepedia.com/Health) and scroll to the section 
"Death Messages", any title here should do (example: `Lava`).
